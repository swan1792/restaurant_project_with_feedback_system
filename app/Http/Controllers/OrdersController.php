...
class OrdersController extends Controller
{
    ...
    // Eager-load the `dish` relationship to prevent null errors
    $orders = Order::where('status', 4)->with('dish')->get();

    return view('kitchen.order_form', compact('dishes', 'tables', 'orders', 'status'));
    }
